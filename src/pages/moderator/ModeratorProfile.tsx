...
type ModeratorProfileFormData = z.infer<typeof moderatorProfileSchema>;
...
export default function ModeratorProfile() {
  ...
  const {
    ...
    setValue,
  } = useForm<ModeratorProfileFormData>({
    resolver: zodResolver(moderatorProfileSchema),
    defaultValues: {
      username: '',
      bio: '',
      skills: '',
